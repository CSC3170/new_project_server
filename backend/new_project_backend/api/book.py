...
async def add_book(adding_book: AddingBook, user: User = Depends(get_current_user)):
    try:
...
async def edit_book(name: str, editing_book: EditingBook, user: User = Depends(get_current_user)):
    try:
...
async def delete_book(name: str, user: User = Depends(get_current_user)):
    try:
